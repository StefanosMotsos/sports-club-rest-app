...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("SportsClub API")
                        .version("1.0.0")
                        .description("""
                                REST API for managing a Sports Club's registry.
                                Provides endpoints for managing members, users, and organizational data.
                                
                                Authentication is done via JWT Bearer tokens.
                                Obtain a token from /api/auth/authenticate before using secured endpoints.
                        """)
                        .contact(new Contact()
                                .name("Stefanos Motsos")
                                .email("stefanosmotsos01@gmail.com")
                                .url("https://github.com/StefanosMotsos"))
                        .license(new License()
